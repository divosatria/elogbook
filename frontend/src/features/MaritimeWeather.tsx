                            ...
                            {selectedLocationWeather && (
                              <div className="mt-2 pt-2 border-t border-slate-200">
                                <p className="font-bold text-lg text-slate-800">
                                  {Math.round(selectedLocationWeather.current.weather.temperature_c)}Â°C
                                </p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-white rounded-lg p-3 shadow-sm">
                      ...
                      <p className="text-base font-bold text-slate-800">
                        {Math.round(selectedLocationWeather.current.weather.feels_like_c)}Â°C
                      </p>
                    </div>
                    <div className="bg-white rounded-lg p-3 shadow-sm">
                      <div className="flex items-center gap-2 text-slate-500 mb-1">
              ...
              <div className="flex gap-3 min-w-max">
                {selectedLocationWeather.forecast.forecasts.slice(0, 8).map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-base font-bold text-slate-800">{Math.round(item.temperature_c)}Â°</p>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
                    <div className="bg-slate-50 rounded-lg p-3">
                      ...
                      <p className="text-base font-bold text-slate-800">
                        {Math.round(openWeatherData.current.weather.feels_like_c)}Â°C
                      </p>
                    </div>
                    <div className="bg-slate-50 rounded-lg p-3">
                      <div className="flex items-center gap-2 text-slate-500 mb-1">
                    ...
                    <tbody>
                      {catchZonesWeather.zones.map((zone, index) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2.5 border-b border-slate-100 text-center">
                            {zone.current ? (
                              <span className="text-sm font-semibold text-slate-700">{Math.round(zone.current.weather.temperature_c)}Â°C</span>
                            ) : (
                              <span className="text-slate-400 text-xs">-</span>
                            )}
                          </td>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    <tr className="bg-white hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-4 py-3 font-bold text-slate-800">
                        {Math.round(selectedZone.current.weather.temperature_c)}Â°C
                      </td>
                    ...
                    <div className="flex gap-6 min-w-max">
                      {selectedZone.forecasts.slice(0, 4).map((forecast, idx) => (
                        <div key={idx} className="text-center min-w-[80px]">
                          ...
                          <p className="text-lg font-bold text-slate-800">{Math.round(forecast.temperature_c)}Â°</p>
