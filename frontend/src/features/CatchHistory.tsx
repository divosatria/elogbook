...
import LocationPickerSimple from '@/components/ui/LocationPickerSimple';
import MapsBlockedNotification from '@/components/ui/MapsBlockedNotification';
import LogbookKKP from '@/components/ui/LogbookKKPModal';
import { useMapsDetection, useNotificationDismissed } from '@/utils/useMapsDetection';

// Import logos for PDF
import logoKementrian from '@/assets/images/logokementrian.png';
import logoIPB from '@/assets/images/logoipbfull.png';
...
const CatchHistory: React.FC<CatchHistoryProps> = ({ onBack }) => {
  ...
  const loadReports = async () => {
    try {
      ...
      const freshReports = Array.isArray(reportsData) ? reportsData.map((report: any) => ({
        ...
        // === Trip & Kapal fields â€” langsung dari backend JOIN, tidak ada fallback ke mobileData ===
  ...
  const handleDownloadMonthlyReport = async (periodOverride?: string) => {
    ...
    try {
      ...
      doc.setFontSize(9);
      doc.setFont("helvetica", "normal");
      doc.text(`â€¢ Total Laporan: ${targetReports.length} transaksi`, 20, summaryY);
      const exportTotalWeight = targetReports.reduce((s, r) => s + (r.weightKg || 0), 0);
      doc.text(`â€¢ Total Berat: ${exportTotalWeight.toLocaleString('id-ID')} Kg`, 20, summaryY + 6);
      doc.text(`â€¢ Total Nilai Ekonomi: Rp ${totalValue.toLocaleString('id-ID')}`, 20, summaryY + 12);

      const totalTax = targetReports.reduce((sum, r) => sum + calculateTax(r.weightKg, r.fishType, r.pricePerKg).taxAmount, 0);
      doc.text(`â€¢ Estimasi Pajak Daerah: Rp ${totalTax.toLocaleString('id-ID')}`, 20, summaryY + 18);
  ...
  // ============================================================
  // LOGBOOK KKP â€” Format resmi sesuai PERMEN-KP 33/2021
  ...
  const handleDownloadLogbookKKP = async (vesselIdFilter?: string) => {
    ...
    try {
      ...
      for (const [vesselKey, vesselReports] of Object.entries(byVessel)) {
        ...
        // â”€â”€ HEADER KOP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        doc.setDrawColor(0);
        doc.setLineWidth(0.8);
        ...
        doc.setFontSize(8);
        doc.setFont('helvetica', 'normal');
        doc.text('(Form C â€” Laporan Harian Kapal Penangkap Ikan)', pageW / 2, y + 23, { align: 'center' });

        y += 32;

        // â”€â”€ NOMOR & TANGGAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ BAGIAN I: IDENTITAS KAPAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        doc.setLineWidth(0.4);
        doc.setFillColor(220, 230, 242);
        doc.rect(margin, y, contentW, 6, 'FD');
        doc.setFontSize(8);
        doc.setFont('helvetica', 'bold');
        doc.text('BAGIAN I â€” IDENTITAS KAPAL DAN NAHKODA', margin + 2, y + 4);
        y += 8;
        ...
        // â”€â”€ BAGIAN II: RINCIAN PERJALANAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        doc.setFillColor(220, 230, 242);
        doc.rect(margin, y, contentW, 6, 'FD');
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(8);
        doc.text('BAGIAN II â€” RINCIAN PERJALANAN', margin + 2, y + 4);
        y += 8;
        ...
        // â”€â”€ BAGIAN III: TABEL HASIL TANGKAPAN HARIAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        doc.setFillColor(220, 230, 242);
        doc.rect(margin, y, contentW, 6, 'FD');
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(8);
        doc.text('BAGIAN III â€” CATATAN HASIL TANGKAPAN HARIAN', margin + 2, y + 4);
        y += 6;
        ...
        // â”€â”€ BAGIAN IV: REKAPITULASI PER JENIS IKAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(8);
        doc.text('BAGIAN IV â€” REKAPITULASI PER JENIS IKAN', margin + 2, y + 4);
        y += 6;
        ...
        // â”€â”€ BAGIAN V: PERNYATAAN & TANDA TANGAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(8);
        doc.text('BAGIAN V â€” PERNYATAAN NAHKODA', margin + 2, y + 4);
        y += 9;
      ...
      // â”€â”€ FOOTER SEMUA HALAMAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      for (let p = 1; p <= totalPages; p++) {
        ...
        doc.text('Logbook Penangkapan Ikan â€” Sistem E-Logbook Maritim | Dinas Kelautan dan Perikanan', margin, 291);
  ...
  // State untuk filter statistik periode â€” dihapus, pakai dateFilter global
  ...
  // â”€â”€ Statistik per periode â€” pakai filteredReports agar filter kapal ikut berpengaruh
  const getPeriodStats = () => {
    ...
    const windowDays = dateFilter === 'today' ? 1
      ...
      : dateFilter === 'week' ? 7
      : dateFilter === 'month' ? 30
      : 30; // 'all' â†’ tampilkan 30 hari terakhir di chart
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-slate-200 divide-y divide-slate-100">
        ...
        <div className="px-4 py-3 flex flex-wrap items-center gap-2">
          ...
          {/* Input rentang tanggal â€” muncul saat aktif */}
          {dateFilter === 'range' && (
...
{/* ... modals ... */}
            ...
            <div className="p-6 border-b border-slate-100 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Form C â€” Laporan Harian Kapal</p>
                </div>
              </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
                ...
                <ul className="text-xs text-blue-600 space-y-0.5">
                  <li>â€¢ Bagian I: Identitas Kapal & Nahkoda</li>
                  <li>â€¢ Bagian II: Rincian Perjalanan</li>
                  <li>â€¢ Bagian III: Catatan Hasil Tangkapan Harian</li>
                  <li>â€¢ Bagian IV: Rekapitulasi per Jenis Ikan</li>
                  <li>â€¢ Bagian V: Pernyataan & Tanda Tangan</li>
                </ul>
              </div>
                  ...
                  >
                    ...
                    {vesselTrips.map((trip: any) => (
                      <option key={trip.id} value={trip.id}>
                        Trip #{trip.id} â€” {new Date(trip.tanggalBerangkat).toLocaleDateString('id-ID')} [{trip.status}]
                      </option>
                    ))}
                  </select>
      ...
      {/* â”€â”€ STATISTIK PERIODE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-slate-400">{periodStats.length} periode â€¢ {filteredReports.length} laporan</span>
        </div>
                  ...
                  <div className="relative w-full flex flex-col items-center justify-end h-24">
                    ...
                    <div className="absolute bottom-full mb-1 hidden group-hover:flex flex-col items-center z-10">
                      <div className="bg-slate-800 text-white text-[10px] font-bold px-2 py-1 rounded whitespace-nowrap">
                        {s.berat.toLocaleString('id-ID')} kg â€¢ {s.count} laporan
                        <br />
      ...
      {/* â”€â”€ SECTION TITIK JARING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className="bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm">
                    ...
                    <tr key={point.id} className="hover:bg-blue-50/40 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center">
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                          ...
                          {point.actionType === 'net_retrieved' ? 'â¬† Angkat' : 'â¬‡ Turun'}
                        </span>
                      </td>
               ...
               {selectedReport.photoUrl && (
                 <div className="bg-slate-900 rounded-2xl overflow-hidden border-4 border-white shadow-xl group relative">
                    ...
                    <div className="absolute bottom-0 inset-x-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                       <p className="text-white/70 text-xs font-medium">Digital Evidence â€¢ Trip #{selectedReport.tripId || 'N/A'}</p>
                    </div>
                 </div>
               )}
...
// â”€â”€ Komponen terpisah agar hooks tidak melanggar Rules of Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                  ...
                  <div className={`px-4 py-2.5 flex items-center justify-between ${
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                        ...
                        {point.actionType === 'net_retrieved' ? 'â¬† Angkat Jaring' : 'â¬‡ Turun Jaring'}
                      </span>
