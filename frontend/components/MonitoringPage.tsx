                  ...
                  <tbody className="divide-y divide-slate-100">
                    {filteredVessels.map((vessel) => (
                      ...
                      >
                        ...
                        {/* Arah */}
                        <td className="py-2.5 px-4">
                          <span className="font-bold text-slate-700 text-xs">{vessel.heading?.toFixed(0) || '0'}°</span>
                        </td>
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                {vessel.distanceFromHarbor.maxMil && (
                                  <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${
                                    ...
                                    {vessel.distanceFromHarbor.isViolating ? '⚠ Melebihi' : '✓ Aman'} {vessel.distanceFromHarbor.maxMil} mil
                                  </span>
                                )}
                              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg p-3 border border-slate-200 shadow-sm">
                  ...
                  <p className="text-sm font-bold text-slate-800">{selectedVessel.heading?.toFixed(0) || '0'}°</p>
                </div>
              </div>
                        ...
                        <div className="flex items-center justify-between mb-1">
                          ...
                          {selectedVessel.distanceFromHarbor.maxMil && (
                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                              ...
                              {selectedVessel.distanceFromHarbor.isViolating ? '⚠ MELEBIHI BATAS' : '✓ DALAM BATAS'}
                            </span>
                          )}
                        </div>
