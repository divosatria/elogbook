...
const RealTimeMonitoringMap: React.FC<RealTimeMapProps> = ({ className = '' }) => {
  ...
  const handleEmergencyAlert = (alert: any) => {
    ...
    const emergencyIcon = L.divIcon({
      html: `
        ...
        ">
          ...
          "></div>
          <span style="color: white; font-size: 24px; z-index: 1;">🚨</span>
        </div>
      `,
    ...
    const emergencyMarker = L.marker([alert.location.lat, alert.location.lng], { 
      ...
      .bindPopup(`
        <div class="p-3">
          <h3 class="font-bold text-red-600 mb-2">🚨 DARURAT</h3>
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <div class="p-2 bg-white rounded-md border border-purple-100 shadow-sm">
                ...
                <div class="flex items-center space-x-1">
                  ...
                  <span class="text-purple-700 font-bold text-xs">${heading.toFixed(0)}°</span>
                </div>
              </div>
            </div>
            ...
            <div class="p-2 bg-white rounded-md border ${
              ...
              <div class="flex items-center justify-between">
                ...
                }">${vessel.distanceFromHarbor.isViolating ? '⚠ MELEBIHI' : '✓ AMAN'}</span>` : ''}
              </div>
              ...
              <span class="text-[10px] text-slate-400 block">dari ${vessel.distanceFromHarbor.harborName}${vessel.distanceFromHarbor.maxMil ? ' · Batas: ' + vessel.distanceFromHarbor.maxMil + ' mil' : ''}</span>
              ...
              <div style="display: grid; gap: 8px; font-size: 12px;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 6px;">
                  ...
                  <div style="background: #dbeafe; padding: 8px 10px; border-radius: 6px;">
                    ...
                    <p style="margin: 3px 0 0 0; color: #1e40af; font-weight: 600;">~${(coords.length * 0.5).toFixed(1)} km²</p>
                  </div>
                </div>
          ...
          <div style="padding:12px;min-width:220px;">
            ...
            <div style="display:grid;gap:6px;font-size:11px;">
              <div style="background:#f0f9ff;padding:6px 8px;border-radius:6px;">
                <span style="color:#0369a1;font-weight:600;">🚢 Kapal:</span>
                <span style="color:#0c4a6e;font-weight:500;margin-left:4px;">${point.kapal?.namaKapal || '-'} (${point.kapal?.nomorKapal || '-'})</span>
              </div>
              <div style="background:#f0f9ff;padding:6px 8px;border-radius:6px;">
                <span style="color:#0369a1;font-weight:600;">🎣 Alat Tangkap:</span>
              ...
              <div style="background:#ecfdf5;padding:6px 8px;border-radius:6px;">
                <span style="color:#065f46;font-weight:600;">🌊 Kedalaman:</span>
              ...
              <div style="background:#f9fafb;padding:6px 8px;border-radius:6px;">
                <span style="color:#6b7280;font-weight:600;">📍 Koordinat:</span>
              ...
              <div style="background:#f9fafb;padding:6px 8px;border-radius:6px;">
                <span style="color:#6b7280;font-weight:600;">🕐 Waktu:</span>
              ...
              <div style="background:#fffbeb;padding:6px 8px;border-radius:6px;border-left:3px solid #f59e0b;">
                <span style="color:#92400e;font-weight:600;">📝 Catatan:</span>
