...
const Nahkoda = require('./vessel/Nahkoda');
const Nelayan = require('./vessel/Nelayan');
const Kapal = require('./vessel/Kapal');
const Trip = require('./trip/Trip');
const TripTask = require('./trip/TripTask');
const OperationalTask = require('./core/OperationalTask');
const VesselCrew = require('./vessel/VesselCrew');
const Emergency = require('./notification/Emergency');
const HasilTangkap = require('./trip/HasilTangkap');
const CatchPolygon = require('./trip/CatchPolygon');
const Weather = require('./core/Weather');
const FishPrice = require('./core/FishPrice');
const EmailSetting = require('./core/EmailSetting');
const HarborZone = require('./monitoring/HarborZone');
const POI = require('./monitoring/POI');
const Perangkat = require('./monitoring/Perangkat');
const FishingPoint = require('./monitoring/FishingPoint');
const EdgeData = require('./monitoring/EdgeData');
