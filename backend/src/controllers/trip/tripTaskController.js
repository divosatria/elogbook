const TripTask = require('../../models/trip/TripTask');
const Trip = require('../../models/trip/Trip');
const { User } = require('../../models');
const VesselCrew = require('../../models/vessel/VesselCrew');
const MobileNotificationService = require('../../services/notification/mobileNotificationService');
  ...
  try {
    ...
    const tasks = await TripTask.findAll({
      include: [
        ...
        {
          model: require('../../models/trip/CatchPolygon'),
          as: 'catchPolygon',
          attributes: ['id', 'name', 'zoneType'],
          required: false
        },
        {
          model: require('../../models/vessel/Kapal'),
          as: 'vessel',
