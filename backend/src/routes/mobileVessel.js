...
const mobileVesselController = require('../controllers/mobileVesselController');
const { authenticate } = require('../middleware/auth');
const { vesselValidation } = require('../middleware/vesselValidation');
const { uploadSertifikat } = require('../middleware/sertifikatValidation');
