...
const profileDocumentController = require('../../controllers/vessel/profileDocumentController');
const { authenticate, authorize } = require('../../middleware/auth/auth');
const { body, param } = require('express-validator');
const { handleValidationErrors } = require('../../middleware/vessel/vesselValidation');
const flexibleUpload = require('../../middleware/core/flexibleUpload');
